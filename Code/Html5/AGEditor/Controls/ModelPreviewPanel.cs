...
namespace AGEditer
{
    public partial class ModelPreviewPanel : UserControl
    {
        ...
        int _curDirectionId;
        Model2D _model;
        public ModelPreviewPanel(Model2D model)
        {
            InitializeComponent();
        ...
        public ModelPreviewPanel(Model2D model, Action2D action)
        {
            InitializeComponent();
        ...
        public ModelPreviewPanel(Model2D model, Action2D action, Direction2D direction)
        {
            InitializeComponent();
